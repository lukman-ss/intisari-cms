...
<div class="wrap">
    ...
    <table class="box" style="width: 100%; border-collapse: collapse; clear: both;">
        ...
        <tbody>
            <?php if (empty($posts)): ?>
                <tr><td style="padding: 10px;"><input type="checkbox" name="ids[]" value="<?= $post->id ?>"></td><td colspan="4" style="padding: 10px;">No posts found.</td></tr>
            <?php else: ?>
                <?php foreach ($posts as $post): ?>
                <tr style="border-bottom: 1px solid #eee;">
                    <td style="padding: 10px;"><input type="checkbox" name="ids[]" value="<?= $post->id ?>"></td><td style="padding: 10px;">
