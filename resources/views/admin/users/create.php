...
<div class="wrap">
    <h1>Add New User</h1>
    <form method="POST" action="/admin/users" class="box" style="max-width: 600px; margin-top: 20px;">
        <?= \App\Support\Csrf::field() ?>
        
        <div style="margin-bottom: 15px;">
            <label style="display:block; margin-bottom:5px;">Username (required)</label>
        ...
        <div style="margin-bottom: 15px;">
            <label style="display:block; margin-bottom:5px;">Password (required)</label>
        ...
        <button type="submit" style="background:#0073aa; color:#fff; border:none; padding:10px 20px; cursor:pointer;">Add New User</button>
    </form>
</div>
